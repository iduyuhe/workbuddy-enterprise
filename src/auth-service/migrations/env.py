...
Each service uses its OWN alembic version table (alembic_version_auth) so multiple services
can share one PostgreSQL instance without clobbering each other's migration
chain (microservice-grade isolation).
"""
...
import app.models.rbac, app.models.org  # noqa: F401
