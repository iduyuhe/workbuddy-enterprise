...
DATABASE_URL = normalize_database_url(os.getenv("DATABASE_URL", "sqlite:///./knowledge.db"))
...
def init_db() -> None:
    ...
    try:
        ...
        print("[knowledge-db] alembic upgrade head OK", flush=True)
    except Exception as e:
        print(f"[knowledge-db] alembic unavailable ({e!r}); fallback create_all", flush=True)
